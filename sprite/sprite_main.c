...
char *failed="{\"step\":\"firmware\",\"PN\":\"xxx\",\"SN\":\"xxx\",\"CN\":\"xxx\",\"result\":{\"module\":\"image\",\"progress\":\"20\", \"state\":\"1\",\"message\":\"write image failed\"}}\r\n";
char *succuess="{\"step\":\"firmware\",\"PN\":\"xxx\",\"SN\":\"xxx\",\"CN\":\"xxx\",\"result\":{\"module\":\"image\",\"progress\":\"20\", \"state\":\"0\",\"message\":\"write image succuess\"}}\r\n";
...
int sunxi_card_sprite_main(int workmode, char *name)
{
	...
	char *plan="{\"step\":\"firmware\",\"PN\":\"xxx\",\"SN\":\"xxx\",\"CN\":\"xxx\",\"plan\":{\"num\":\"1\",\"modules\":{\"image\":\"0\"}}}\r\n";
	// printf("U-Boot 2018.07-00001-ge835272\n");
	// mdelay(1000);
	// printf("Starting kernel ...\n");
	// mdelay(1000);
	// printf("VFS: Mounted root (ext4 filesystem)\n");
	// mdelay(1000);

	printf("MYD_LT527 login:\n");
	mdelay(2000);
	printf(">>>[%d]%s",(int)strlen(plan),plan);
	...
	if (sprite_card_firmware_probe(name)) {
		...
		printf(">>>[%d]%s",(int)strlen(failed),failed);
		return -1;
	}
#ifdef CONFIG_SUNXI_SPRITE_CARTOON
	...
	printf(">>>[%d]%s",(int)strlen(succuess),succuess);
	//烧写结束
	mdelay(3000);
	//处理烧写完成后的动作
